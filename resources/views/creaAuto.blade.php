    ...
    @endif
      <form method="post" action="{{ route('autos.store') }}">
          ...
          <div class="form-group">
              ...
              <input type="text" class="form-control" name="Nombre_places"/>
          </div>
          <div class="form-group">
              <label for="Nombre_portes">Nombre de portes</label>
              <input type="text" class="form-control" name="Nombre_portes"/>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
              ...
              <input type="text" class="form-control" name="Tipus_combustible"/>
          </div>
