        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="underline flex justify-center pt-8 sm:justify-start sm:pt-0">
                    <h2>Projecte amb BD MySQL i framework Laravel 8</h2>
                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        <div class="p-6">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold"><a href="{{ url('autos/create') }}" class="underline text-gray-900 dark:text-white">Afegeix Autos</a></div>
                            </div>

                            <div class="ml-12">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                    Accés a la vista per afegir nous Autos a la base de dades.
                                </div>
                            </div>
                        </div>
                        <div class="p-6">
                        ...
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-l">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold text-gray-900 dark:text-white"><a href="{{ url('autos') }}" class="underline text-gray-900 dark:text-white">Llista d'autos i accions (esborra/edita)</a></div>
                            </div>

                            <div class="ml-12">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                   Accés a la vista per visualitazar la llista d'autos i enllaços a les opcions d'esborrar i modificar dades d'autos existents.
                                </div>
                            </div>
                        </div>
                        <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-l">
